...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-8">
        <div className="relative w-full h-[750px] bg-black text-white flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <p className="text-xl">
              Modern design. Smooth Workflow. Fast Learning.
            </p>
          </div>
      ...
      <div
        {...handlers}
        className="flex flex-col gap-8 py-[80px] cursor-pointer"
      >
        <div className="relative w-full h-[750px] bg-black text-white flex items-center justify-center overflow-hidden">
          <AnimatePresence>
            <motion.div
        ...
        <div className="text-center md:px-[100px] flex flex-col items-center gap-y-[30px] px-6">
          ...
          <div className="max-w-5xl flex flex-col gap-y-6 text-gray-300 text-[14px] md:text-[18px] leading-relaxed">
            <p>
              ...
              collaboration solutions that enable immersive communications.
              Since established in 2017, we have enhanced team creativity and
              productivity worldwide by providing advanced audio-visual
              technologies and one-stop solutions.
            </p>
            <p>
              MAXHUB Ecosystem focuses on a total solution for complete
              scenarios. From smart Interactive Displays, to high-quality UC
              products, to ground-breaking all-in-one LED and eye-catching
              Digital Signage, to Mobile Stands for flexible work, we’ve got you
              covered.
            </p>
          </div>
